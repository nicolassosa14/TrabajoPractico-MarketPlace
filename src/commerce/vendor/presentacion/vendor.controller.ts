import { Controller, Delete, Get, Param, ParseIntPipe, Patch, Post, Put, Body } from '@nestjs/common';
...
export class VendorController {
    ...
    async updatePartial(
        ...
        const command = new UpdatePatchVendorCommand(id, dto.name, dto.email, dto.password, dto.descripcion, dto.address, dto.is_active);
